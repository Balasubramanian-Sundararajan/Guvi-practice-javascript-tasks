...
let oddNum = num.filter(function(result) {
   return (result % 2 === 1);
});
...
function titleCase(str) {
  ...
  console.log(titleCase("welcome team"));
...
console.log(titleCase('sachin tendulkar'));
console.log(titleCase('virat kohli'));
...
let arrList =  ['abc', 'hello', 'abcdcba', 'appa', 'madam']
